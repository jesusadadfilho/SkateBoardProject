...
void ASkateProjectCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ASkateProjectCharacter::Look);
	}
	else
	{
...
void ASkateProjectCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ASkateProjectCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
